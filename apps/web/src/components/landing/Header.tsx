            ...
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Link href="/auth/signup">
                        <button className="px-6 py-2 bg-gradient-to-b from-violet-600 to-violet-800 text-white rounded-lg transition-all duration-300 border border-violet-500/50 hover:shadow-lg hover:shadow-violet-500/20">
                            Get Started
                        </button>
                    </Link>
                </div>
                    ...
                    <div className="container mx-auto px-4 py-4 space-y-4">
                        ...
                        <div className="pt-4 space-y-2">
                            ...
                            <Link href="/auth/signup" className="block">
                                <button className="w-full px-6 py-2 bg-gradient-to-b from-violet-600 to-violet-800 text-white rounded-lg transition-all duration-300 border border-violet-500/50">
                                    Get Started
                                </button>
                            </Link>
                        </div>
